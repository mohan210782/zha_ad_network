...
$ npm i -g @nestjs/cli
$ git clone https://github.com/mohan210782/bluetrade.git
$ cd bluetrade
$ npm install
```
...
RESET_PASSWORD_REQUEST_URL=http://localhost:3000/forgetpassword
...
- Author - [Hinton](http://hintonservices.in)
